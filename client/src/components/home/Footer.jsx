...
const Footer = () => {
  return (
    <>
      ...
      <footer className="flex flex-wrap justify-center lg:justify-between overflow-hidden gap-10 md:gap-10 py-16 px-6 md:px-16 lg:px-24 xl:px-32 text-[13px] bg-gradient-to-b from-slate-900 via-slate-800 to-slate-900">
